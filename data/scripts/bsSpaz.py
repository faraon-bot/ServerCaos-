...
class Appearance(object):
    ...
    def __init__(self, name):
        ...
        self.colorTexture = "aliColor"
        self.headModel = "operaSingerHead"
        self.torsoModel = "robotTorso"
        self.pelvisModel = "bonesPelvis"
        self.upperArmModel = "bonesUpperArm"
        self.foreArmModel = "kronkForeArm"
        self.handModel = "ninjaHand"
        self.upperLegModel = "zoeUpperLeg"
        self.lowerLegModel = "zoeLowerLeg"
        self.toesModel = "aliColor"
        self.jumpSounds = "aliSounds"
        self.attackSounds = "cyborgHitSounds"
        self.impactSounds = "cyborgSounds"
        self.deathSounds = "cyborgDeath"
        self.pickupSounds = "cyborgSounds"
        self.fallSounds = "cyborgFall"
        self.style = 'cyborg'
        self.defaultColor = (0.3, 0.3, 0.33)
        self.defaultHighlight = (1, 0.5, 0.3)
